...
public class PanelAnadir extends PanelPadre {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (panelLibro.isVisible()) {
					...
					if(rdbtnCartas.isSelected())
					 ...
					 try {
						Principal.stock.addToStock(new
						 Figura(textNombre.getText(), textDetalles.getText(),Double.parseDouble(textPrecio.getText()),
						 (EstadoArticulo) comboBoxEstado.getSelectedItem(),LocalDate.now(),
						  (double)(spinnerPeso.getValue()),textTematica.getText(),chkbxColeccion.isSelected(),chckbxDesmontable.isSelected(),
						  (int)(numElementos.getValue())), Integer.parseInt(textStock.getText()));
	...
	protected void habilitarTablero() {
		// TODO Auto-generated method stub
		
	}

	protected void habilitarRol() {
		// TODO Auto-generated method stub
